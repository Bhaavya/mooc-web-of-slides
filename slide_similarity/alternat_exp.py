...
def find_alt_exp(title_path,content_path,slide_names_path,out_path,alpha=1):
	...
	util.get_top_slides(alt_exp_score,out_path,slide_names,addn_info_keys_mat=['title_sim','content_sim'],addn_info_mat=[title_sim,content_sim],addn_info_keys_lst=['title','content'],addn_info_lst=[ss1.corpus,ss2.corpus])
