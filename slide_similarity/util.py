...
def get_top_slides(score_mat,out_path,slide_names,k=10,addn_info_keys_mat=None,addn_info_mat=None,addn_info_keys_lst=None,addn_info_lst=None):
		...
		for i,slide in enumerate(most_sim_argmat):
			...
			for sim_slide in slide:
				...
				for j,key in enumerate(addn_info_keys_lst):
					sim_dict[key] = addn_info_lst[j][sim_slide]
